...
import { fetchSystemLedger, downloadLedgerCsv } from '../../features/ledger/ledgerSlice';
    ...
    return (
        <div className="p-6">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">System Ledger</h1>
                    <p className="text-gray-600 text-sm mt-1">Immutable record of all balance changes.</p>
                </div>
                <button
                ...
                <table className="w-full text-left">
                    ...
                    <tbody>
                        {loading ? (
                            ...
                            <tr><td colSpan={8} className="p-4 text-center text-gray-500">No ledger entries found.</td></tr>
                        ) : (
                            entries.map(entry => (
